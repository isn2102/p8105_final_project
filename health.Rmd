...
health_data_final <-
  ...
  select(community_board, obesity, hypertension, life_expectancy, self_rep_health, garden_num, id_spatial) #%>% 
...
> Distribution of number of gardens across community boards.
