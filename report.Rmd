...
The second tidied dataset (`final_unique_gardens`) contains 535 rows (the number of unique community gardens): variables included denotes with **
Variables existing in both dataset denotes with ***
  ...
  * `avg_tot_appropriated`. Average amount of participatory budgeting allocated for all projects per a community board. ***
...
**Notes:** Visualization of the distribution of community gardens in New York City, colored by average percent poverty in each community board location. Poverty: percentage of residents living below 100% of NYC's calculated poverty threshold, based on income and necessary expenses.
