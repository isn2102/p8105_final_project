...
lagrange_df %>% 
  ...
  kable_styling() %>% 
  row_spec(1:3, color = "black", background = "#ceebcc") 
```
...
rbind(obesity_lag_df, hypertension_lag_df, life_expect_lag_df, self_rep_lm_df) %>%
  ...
  row_spec(11, color = "black", background = "#ceebcc") %>% 
...
* also possible that since we have such a small sample size (59 obs), there is not enough variation in the health outcomes for community districts with different numbers of gardens- ex: if every single one of the community districts that has a lot of gardens has very poor health outcomes because of historic disenfranchisement and poverty, we may not be able to see any minimal positive impact of gardens becuase of the much larger impact of historic poverty 
