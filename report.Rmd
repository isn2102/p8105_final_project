...
The first tidied dataset (`final_unique_boards`) contains 59 observations (the number of community boards in NYC): variables included denoted with *
The second tidied dataset (`final_unique_gardens`) contains 535 rows (the number of unique community gardens):  

* Variables included denotes with **
