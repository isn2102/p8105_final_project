...
**Notes:** Visualization of the distribution of hypertensio across community boards. Hypertension: Percentage of adults ages 18 and older who report ever being told by a healthcare professional that they have hypertension, also known as high blood pressure. Data from the NYC 2018 Community Health Profiles.
...
**Notes:** Visualization of the distribution of life expectancy across community boards. Life expectancy: Life expectancy at birth. Data from the NYC 2018 Community Health Profiles.
...
![](images/spatial_model.jpeg){ height="400px" width="350px" }
...
rbind(obesity_lag_df, hypertension_lag_df, life_expect_lag_df, self_rep_lm_df) %>%
  ...
  row_spec(3, color = "black", background = "#EBE4CC") %>% 
  row_spec(7, color = "black", background = "#EBE4CC") %>% 
  row_spec(11, color = "black", background = "#ceebcc", bold = TRUE) %>% 
...
**Notes:** We assessed Moran's I for the final, spatially adjusted models and found no significant p-values.
