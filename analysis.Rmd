...
summary(health_nbq)
health_nbq_w <- nb2listw(health_nbq, zero.policy = TRUE)
...
###Getting warning: NAs in lagged values
###Getting error: out-of-range p-value: reconsider test arguments, and p-values are NA
