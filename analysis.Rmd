...
```{r}
analysis_data_final %>% 
  ggplot(aes(x = log_garden_num, y = poverty)) +
  geom_point()

analysis_data_final %>% 
  ggplot(aes(x = log_garden_num, y = obesity)) +
  geom_point()

analysis_data_final %>% 
  ggplot(aes(x = log_garden_num, y = hypertension)) +
  geom_point()

analysis_data_final %>% 
  ggplot(aes(x = log_garden_num, y = life_expectancy)) +
  geom_point()

analysis_data_final %>% 
  ggplot(aes(x = log_garden_num, y = self_rep_health)) +
  geom_point()
