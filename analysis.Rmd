...
Load data and select variables. Had to remove one community garden that didn't have any neighbors because was getting error when running the spatial regression.
