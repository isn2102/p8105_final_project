...
We fit general linear regression modesl and ran Lagrange Multiplier tests on these to identify the appropriate type of spatial regression model to use. See flow chart below for our thought process: 
