...
# Map of community boards regions and individual gardens. 111 gardens were missing longitude and latitude, so their individual leaf locations are missing from the map.
...
> Label text specifies the total number of gardens in a given community board. Gardens were designated as being part of a community board based on their community board label in the original gardens dataset, therefore gardens without latitude and longitude values (n = 111) are included in the label text but not as an individual data point on the map.
...
> Proportion of age categories in each community board.
...
> Proportion of education levels in each community board.
...
> Proportion of race categories in each community board.